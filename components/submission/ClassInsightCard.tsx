        ...
        <div key={key} className="relative inline-block">
          ...
          {isOpen && (
            <>
              ...
              <div ref={openRefRef} className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-[101] w-[480px] max-h-[85vh] overflow-y-auto rounded-2xl border border-surface-200 bg-white shadow-2xl">
                {/* Header */}
                <div className="sticky top-0 bg-white border-b border-surface-100 px-5 py-3 flex items-center justify-between">
                ...
                <div className="p-5 space-y-4">
                  ...
                  <div className="bg-surface-50 rounded-xl p-4 border border-surface-100">
                    ...
                    <p className="text-base text-surface-800 italic leading-relaxed">&quot;{ref.text}&quot;</p>
                  </div>
                  
                  {/* Pedagogical Analysis - Train of Thought */}
                  <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-4 border border-blue-100">
                    <p className="text-xs font-semibold text-blue-700 uppercase tracking-wide mb-3">Why This Moment Matters</p>
                    <div className="space-y-3 text-sm text-blue-900 leading-relaxed">
                      <p><strong>Context:</strong> This specific segment was selected because it represents a key moment in the student&apos;s presentation that directly relates to the assessment criterion being evaluated. The timing ({ref.timestamp}) places this within the broader arc of their argument.</p>
                      <p><strong>What to observe:</strong> Listen for how the student articulates their understanding. Are they using discipline-specific terminology correctly? Is there evidence of critical thinking, or are they reciting memorized content? Pay attention to their delivery—confidence, pacing, and clarity often signal depth of understanding.</p>
                      <p><strong>Pedagogical connection:</strong> This clip serves as primary evidence for the feedback point it&apos;s attached to. When discussing this with the student, you can point to this exact moment to ground your assessment in observable behavior rather than abstract evaluation. Students respond better to feedback anchored in specific, reviewable moments.</p>
                      <p><strong>For your records:</strong> If you need to justify this grade to the student, a department chair, or during grade appeals, this timestamped evidence provides objective documentation of the student&apos;s demonstrated competency (or areas for growth) at this point in their presentation.</p>
                    </div>
                  </div>
        ...
        <div key={key} className="relative inline-block">
          ...
          {isOpen && (
            <>
              ...
              <div className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-[101] w-[480px] max-h-[85vh] overflow-y-auto rounded-2xl border border-surface-200 bg-white shadow-2xl">
                {/* Header */}
                <div className="sticky top-0 bg-white border-b border-surface-100 px-5 py-3 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-base font-semibold text-surface-900">{ref.title}</p>
                ...
                <div className="p-5 space-y-4">
                  ...
                  <div className="bg-surface-50 rounded-xl p-4 border border-surface-100">
                    ...
                    <p className="text-base text-surface-800 leading-relaxed">{ref.explanation || 'This criterion defines the expectations against which the student\'s performance is being evaluated.'}</p>
                  </div>
                  
                  {/* Pedagogical Analysis - Train of Thought */}
                  <div className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-xl p-4 border border-orange-100">
                    <p className="text-xs font-semibold text-orange-700 uppercase tracking-wide mb-3">Why This Criterion Applies</p>
                    <div className="space-y-3 text-sm text-orange-900 leading-relaxed">
                      <p><strong>Rubric alignment:</strong> The feedback point this reference is attached to directly addresses expectations outlined in the &quot;{ref.title}&quot; section of your rubric. This isn&apos;t a generic connection—the specific strength or area for development identified maps to measurable criteria you&apos;ve established for this assignment.</p>
                      <p><strong>Why this matters pedagogically:</strong> Students often struggle to understand why they received a particular score. By explicitly connecting your feedback to rubric criteria, you&apos;re teaching them to read rubrics as roadmaps for success, not just evaluation tools. This metacognitive skill transfers across courses and disciplines.</p>
                      <p><strong>For student conferences:</strong> When meeting with students about their work, you can pull up this criterion and walk through exactly how their performance mapped (or didn&apos;t map) to each descriptor. This transforms a potentially defensive conversation into a collaborative analysis of their work.</p>
                      <p><strong>Institutional documentation:</strong> If grades are ever questioned—whether by the student, parents, or administration—having explicit rubric-to-feedback connections demonstrates rigorous, fair, and transparent evaluation practices aligned with best practices in outcomes-based assessment.</p>
                    </div>
                  </div>
                </div>
                ...
                {/* Footer Actions */}
                {ref.documentUrl && (
                  <div className="sticky bottom-0 bg-white border-t border-surface-100 px-5 py-3">
                    <a
